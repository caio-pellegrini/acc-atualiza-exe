...
class AutomatedUpdateGUI: 
    def __init__(self, root): 
        ...
        # Define o valor padrão para a pasta PROGS e permite alteração.
        ...
        # Log inicial e log da definição do caminho padrão da PROGS.
    ...
    def run_etapa2_execution_phase(self): 
        try: 
            ...
            summary_msg = f"""Processo de atualização finalizado!\n\n✅ Arquivos atualizados com sucesso: {arquivos_atualizados_count}\n❌ Erros encontrados durante a operação: {erros_count}""" 
